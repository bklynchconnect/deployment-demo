# Flask app demo
# this is a demo .py file that will set up a Flask API enabling us to run our model (and show off some other simple
# functionality)

# note that we'll take advantage of functions we've already written in 'used_cars_inference.py'
...
import pandas as pd
import time
from used_cars_inference import loadModel
...
def blah():
    '''
        This function simply demonstrates a basic end-point at /blah that shows some unoriginal text.
    '''
